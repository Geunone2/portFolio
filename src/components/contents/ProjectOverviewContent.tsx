    ...
    if (deviceType === 'mobile') {
        ...
        return (
            <div
                ...
                <div
                    className="bg-white/10 backdrop-blur-xl rounded-b-3xl border border-white/20 shadow-2xl w-full mx-4 p-4 relative pointer-events-auto">
                    {onBack && (
                        <button
                            onClick={onBack}
        ...
        >
            <div className="animate-item">
                ...
                <p className="text-gray-300 text-center
                    tablet:text-base tablet:mb-3
                    desktop:text-xl desktop:mb-2
                ">
                    참여한 프로젝트들을 소개합니다.
                </p>
            </div>

            <div className="animate-item bg-white/5 rounded-xl border border-white/10
                tablet:p-3
                desktop:p-4
            ">
