        ...
        >
            ...
            <div className="mb-6">
                ...
                <div className="flex items-center gap-2 text-black animate-item">
                    ...
                    <span className="text-sm">{PROJECTS.lowPoly.period}</span>
                </div>
            </div>
            ...
            <p className="text-black mb-6 animate-item text-start">
                {PROJECTS.lowPoly.description}
            </p>

            {/* 기술 스택 */
            }
            <div className="mb-6 animate-item">
                <h3 className="text-lg font-semibold text-purple-400 text-start mb-3">Tech Stack</h3>
                <div className="flex flex-wrap gap-2">
                    {PROJECTS.lowPoly.techStack.map((tech, index) => (
                        <span
                            key={index}
            ...
            <div className="animate-item">
                ...
                <ul className="space-y-2">
                    {PROJECTS.lowPoly.features.map((feature, index) => (
