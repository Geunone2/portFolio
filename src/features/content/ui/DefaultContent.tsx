        ...
        >
            ...
            <div className="fade-in-element pb-20 flex justify-center px-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl">
                    <div className="flex flex-col items-center gap-3 px-6 py-5 bg-black/60 backdrop-blur-md rounded-2xl border border-white/10">
                        <div className="w-12 h-12 flex items-center justify-center text-purple-400">
                            <svg width="40" height="60" viewBox="0 0 40 60">
                                <rect x="10" y="10" width="20" height="40" rx="10" fill="none" stroke="currentColor" strokeWidth="2" />
                                <circle ref={scrollDotRef} cx="20" cy="20" r="3" fill="currentColor" />
                            </svg>
                        </div>
                        <h3 className="text-white font-semibold">스크롤</h3>
                        <p className="text-sm text-gray-300 text-center">마우스 휠을 사용하여<br />섹션 간 순차적으로 이동</p>
                    </div>

                    <div className="flex flex-col items-center gap-3 px-6 py-5 bg-black/60 backdrop-blur-md rounded-2xl border border-white/10">
                        <div className="w-12 h-12 flex items-center justify-center text-purple-400">
                            <svg width="40" height="60" viewBox="0 0 40 60">
                                <circle ref={clickCircleRef} cx="20" cy="30" r="8" fill="none" stroke="currentColor" strokeWidth="2" />
                                <circle cx="20" cy="30" r="3" fill="currentColor" />
                            </svg>
                        </div>
                        <h3 className="text-white font-semibold">클릭</h3>
                        <p className="text-sm text-gray-300 text-center">3D 오브젝트를 클릭하여<br />원하는 섹션으로 바로 이동</p>
                    </div>

                    <div className="flex flex-col items-center gap-3 px-6 py-5 bg-black/60 backdrop-blur-md rounded-2xl border border-white/10">
                        <div className="w-12 h-12 flex items-center justify-center text-purple-400">
                            <svg width="40" height="60" viewBox="0 0 40 60">
                                <rect x="8" y="20" width="24" height="20" rx="2" fill="none" stroke="currentColor" strokeWidth="2" />
                        ...
                        <p className="text-sm text-gray-300 text-center">상단 메뉴를 통해<br />카테고리별로 빠르게 접근</p>
                    </div>
                </div>
            </div>
        </div>
